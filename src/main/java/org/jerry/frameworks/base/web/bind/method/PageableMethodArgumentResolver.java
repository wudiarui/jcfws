 ...
 */
package org.jerry.frameworks.base.web.bind.method;
...
public class PageableMethodArgumentResolver extends BaseMethodArgumentResolver {
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer, NativeWebRequest webRequest, WebDataBinderFactory binderFactory) throws Exception {
        ...
        PageableDefault pageableDefaults = getPageableDefaults(parameter);
        //默认的page request
    ...
    private Pageable getDefaultFromAnnotationOrFallback(PageableDefault pageableDefaults) {
    ...
    private PageableDefault getPageableDefaults(MethodParameter parameter) {
        //首先从参数上找
        PageableDefault pageableDefaults = parameter.getParameterAnnotation(PageableDefault.class);
        //找不到从方法上找
        if (pageableDefaults == null) {
            pageableDefaults = parameter.getMethodAnnotation(PageableDefault.class);
        }
        return pageableDefaults;
    }

    private Pageable defaultPageable(PageableDefault pageableDefaults) {
